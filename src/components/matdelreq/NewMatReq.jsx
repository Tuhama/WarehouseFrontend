...
import MatReqGrid from "./MatReqGrid";
            ...
            <div>
               <Form  onSubmit={this.handleSubmit} >
                <Row>
                    ...
                    <Col span={6}>
                   <FormHeader folderNum={this.state.folderNumber.text} serialNum={this.state.serialNumber.text} date={this.state.date.text} onInputChange={this.handleInputChange}/>
                    </Col>
                    <Col span={18}>
                        <Row>
